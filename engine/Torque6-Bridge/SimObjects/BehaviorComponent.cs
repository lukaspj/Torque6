...
namespace Torque6_Bridge.SimObjects
{
   public unsafe class BehaviorComponent : DynamicConsoleMethodComponent
   {
      ...
      new internal struct InternalUnsafeMethods
      {
         ...
         [DllImport("Torque6_DEBUG", CallingConvention = CallingConvention.Cdecl)]
         internal static extern bool BehaviorComponentRemoveBehavior(IntPtr component, IntPtr inst);
      ...
      public void RemoveBehavior(BehaviorInstance inst)
      {
         if (IsDead()) throw new SimObjectPointerInvalidException();
         InternalUnsafeMethods.BehaviorComponentRemoveBehavior(ObjectPtr->ObjPtr, inst.ObjectPtr->ObjPtr);
      }
      ...
      public void Raise(BehaviorInstance outputBehavior, string outputName, uint timeDelta)
      {
         if (IsDead()) throw new SimObjectPointerInvalidException();
